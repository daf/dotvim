...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#808080 guibg=NONE ctermfg=112
    hi ColorColumn gui=NONE guifg=NONE guibg=#121212 ctermfg=15
    hi Comment gui=NONE guifg=#707070 guibg=NONE ctermfg=253 ctermbg=234
    hi Conceal gui=NONE guifg=#808080 guibg=NONE ctermfg=15
    hi Conditional gui=NONE guifg=#8f8f8f guibg=NONE ctermfg=15
    hi Constant gui=NONE guifg=#808080 guibg=NONE ctermfg=15
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#121212
    hi CursorLine gui=NONE guifg=NONE guibg=#1a1a1a ctermbg=234
    hi CursorLineNr gui=NONE guifg=#ffffff guibg=#121212 ctermfg=112 ctermbg=234
    ...
    hi DiffText gui=NONE guifg=NONE guibg=#333333 ctermfg=15
    hi Directory gui=NONE guifg=#acdb0f guibg=#141414 ctermfg=15
    hi Error gui=NONE guifg=NONE guibg=#171717 ctermfg=255
    hi ErrorMsg gui=NONE guifg=#2b2b2b guibg=#121212
    hi FoldColumn gui=NONE guifg=#616161 guibg=NONE
    hi Folded gui=NONE guifg=#707070 guibg=NONE ctermfg=15
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=NONE guibg=#333333
    hi LineNr gui=NONE guifg=#acdb0f guibg=#121212 ctermfg=236 ctermbg=234
    hi MatchParen gui=NONE guifg=NONE guibg=#333333 ctermfg=15
    ...
    hi Normal gui=NONE guifg=#ffffff guibg=#141414 ctermfg=15
    ...
    hi PmenuSel gui=NONE guifg=#acdb0f guibg=#1a1a1a ctermfg=255 ctermbg=234
    hi PmenuThumb gui=NONE guifg=NONE guibg=#ffffff
    hi Question gui=NONE guifg=NONE guibg=NONE ctermfg=255
    hi Search gui=NONE guifg=NONE guibg=#262626
    hi SignColumn gui=NONE guifg=#616161 guibg=NONE ctermfg=255
    hi Special gui=NONE guifg=#808080 guibg=NONE ctermfg=268
    ...
    hi Statement gui=NONE guifg=#ffffff guibg=NONE ctermfg=112
    ...
    hi String gui=NONE guifg=#808080 guibg=NONE ctermfg=15
    hi TabLine gui=NONE guifg=#303030 guibg=#121212 ctermbg=234 ctermfg=15
    hi TabLineFill gui=NONE guifg=#808080 guibg=#121212 ctermbg=234 ctermfg=236
    hi TabLineSel gui=bold guifg=#acdb0f guibg=#141414 ctermfg=154 ctermbg=234
    hi Title gui=NONE guifg=#ffffff guibg=NONE ctermbg=234 ctermfg=236
    hi Todo gui=standout guifg=NONE guibg=NONE ctermfg=255
    hi treeDir guifg=#FFFFFF guibg=#191919 ctermfg=154 ctermbg=234
    hi Type gui=NONE guifg=#8f8f8f guibg=NONE ctermfg=255
    hi Underlined gui=NONE guifg=NONE guibg=NONE ctermfg=15
    hi VertSplit gui=NONE guifg=#333333 guibg=NONE ctermfg=234 ctermbg=NONE
    hi Visual gui=NONE guifg=NONE guibg=#121212 ctermfg=15
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE ctermfg=15
    hi WarningMsg gui=NONE guifg=#ff0000 guibg=#121212
    hi WildMenu gui=NONE guifg=NONE guibg=#141414
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE ctermfg=255
    hi PreProc gui=NONE guifg=NONE guibg=NONE ctermfg=15
endif
